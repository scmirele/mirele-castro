    ...
    <S.Container id="about-me">
      <S.AboutContainer>
        ...
        <S.TextAboutMe>
          ...
          intuitivas que atendam às necessidades dos usuários. Atualmente, estou
          fazendo graduação em Design, onde continuo a expandir meu conhecimento
          e habilidades na área. Tenho participado de projetos colaborativos que
          me permitiram desenvolver habilidades de trabalho em equipe e
          aprimorar minha criatividade na resolução de problemas de design.
        </S.TextAboutMe>
      </S.AboutContainer>
