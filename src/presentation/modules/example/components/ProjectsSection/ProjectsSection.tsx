      ...
      <S.ProjectContainer reverse={false}>
        ...
        <S.ProjectTextContainer>
          ...
          <S.ProjectInfoDescription>
            ...
            às necessidades tanto de profissionais da área quanto do público em
            geral. Além disso, ele fornece informações completas e detalhadas
            sobre o escritório de advocacia, suas áreas de atuação, e os
            serviços oferecidos.
          </S.ProjectInfoDescription>
          <S.ShowMore>
      ...
      <S.ProjectContainer reverse={true}>
        <S.ProjectImageContainer>
          ...
          <S.TechnologiesUsedContainer>
            <S.ContentOfTechnologies>
              <S.Title>DATA</S.Title>
              <S.Description>Setembro de 2023 - Outubro de 2023</S.Description>
            </S.ContentOfTechnologies>
            <S.ContentOfTechnologies>
              <S.Title>FERRAMENTA</S.Title>
              <S.Description>Figma</S.Description>
        ...
        <S.ProjectTextContainer>
          ...
          <S.ProjectInfoDescription>
            ...
            das crianças, fornecendo orientações e informações essenciais. Além
            disso, oferecerá recursos para monitorar o desenvolvimento infantil,
            visando se tornar uma carteira digital completa para a saúde das
            crianças.
          </S.ProjectInfoDescription>
          <S.ShowMore>
            SAIBA MAIS <CImage src={IconRightArrow} alt="" />
